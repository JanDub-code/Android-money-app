...
@Composable
fun DepositScreen(navigationRouter: INavigationRouter,navController: NavHostController = rememberNavController()){
    ...
    Column(
        ...
        Surface(
            ...
            Box(contentAlignment = Alignment.Center) {
                Text(
                    text = stringResource(id = R.string.addnewdep),
                    color = Color.Black,
        ...
        val typeFromResource = stringResource(id = R.string.deposit)
