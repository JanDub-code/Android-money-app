...
@Composable
fun EditScreen(navigationRouter: INavigationRouter,id : Long?,navController: NavHostController = rememberNavController()){
    ...
    Column(
        ...
        Surface(
            ...
            Box(contentAlignment = Alignment.Center) {
                Text(
                    text = stringResource(id = R.string.change_trans),
                    color = Color.Black,
        ...
        OutlinedTextField(
            value = data.transaction.type.toString() ,//.toString().takeIf { it.isNotEmpty() } ?: "",
            onValueChange = {
